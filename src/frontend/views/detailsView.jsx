...
}, props["userWatchlist"])) ? (<IconHeart className="select-none stroke-red-500 fill-red-500"></IconHeart>) : (null)} {(not.call(null, some.call(null, function (_PERCENT_1) {
return _EQ_.call(null, props["values"]["id"], _PERCENT_1);
}, props["userWatchlist"]))) ? (<IconHeart className="select-none"></IconHeart>) : (null)}</div></div> <div className="text-left w-2/3 h-1/3 mt-4">Plot:  {plot}</div> <div className="h-1/3 mt-4 flex flex-col">Stars:  {map.call(null, generate_stars, stars)}</div> <div className="self-start text-left w-2/3 h-1/3 mt-4 font-bold">{(seq.call(null, seasons)) ? ("Seasons:") : ("")}</div> <div className="flex flex-row flex-wrap">{(seq.call(null, seasons)) ? (map.call(null, function (_PERCENT_1) {
