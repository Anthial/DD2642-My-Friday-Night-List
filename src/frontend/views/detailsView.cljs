...
(defn generate-view [episode]
  (let [id (:id episode)
    ...
    #jsx [:div {:key id :className "flex container flex-col items-center text-center w-full md:w-80 h-[600px] mt-2 bg-[#006466] p-8 lg:m-5 rounded-lg"}
          ...
          [:div {:className "flex flex-col items-center mt-4"} [:span {:className "w-64 h-40 text-elipsis overflow-hidden ..."} description]]
